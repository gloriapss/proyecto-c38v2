...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    //establece la velocidad de cada objeto game en 0
...
function spawnShrubs() {
  //escribe el código aquí para generar las nubes
  if (frameCount % 150 === 0) {
...
function spawnObstacles() {
  if(frameCount % 120 === 0) {
    ...
    obstacle.scale = 0.15;
    //asignar escala y vida útil al obstáculo        
